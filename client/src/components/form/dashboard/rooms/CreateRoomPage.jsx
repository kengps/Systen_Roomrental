...
import { Grid, Card, CardContent, Typography, TextField, Button, Collapse, Box, InputAdornment } from '@mui/material';
import ExpandMoreIcon from '@mui/icons-material/ExpandMore';
import { styled } from '@mui/material/styles';
const CreateRoomPage = ({ register, errors, handleSubmit, onFinish, onSubmit, rooms, handleAddRooms, disabled, groupedRooms, floors, roomsPerFloor, price, count }) => {
