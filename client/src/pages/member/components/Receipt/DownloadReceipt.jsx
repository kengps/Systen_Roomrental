...
export const downloadReceipt = async (bill) => {
    try {
        // สร้าง HTML สำหรับ PDF (ไม่มี script auto-print)
        const receiptHtml = `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                <div class="receipt-container">
                    ...
                    <div class="info-row">
                        ...
                        <span>${bill.apartment?.roomNumber || 'N/A'}</span>
                    </div>
                    <div class="info-row">
        ...
        link.href = url;
        link.download = `ใบเสร็จ-${bill.billNumber}-${getThaiMonthName(bill.billingPeriod?.month)}-${bill.billingPeriod?.year}.html`;
